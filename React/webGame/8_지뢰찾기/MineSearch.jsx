...
export const CODE = {
  ...
  FLAG_MINE: -5,
  CLICKED_MINE: -6,
  OPENED: 0 // 0 이상이면 다 OPENED가 되도록 만들기 위해 0 할당
}

export const TableContext = createContext({ 
  // 초기값을 넣을 수 있는데 지금은 큰 의미 없으니 모양만 맞춰주자.
  tableData: [],
  halted: true,
  dispatch: () => {}
})
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case OPEN_CELL: {
      ...
      // tableData[action.row] = [...state.tableData[action.row]] // 어떤 칸이 불변성이 안지켜질지 몰라서 모든 칸을 다 새로 만들어주었다
